...
public class Porter {
    ...
    private boolean hasSuffix(String word, String suffix, NewString stem) {
        ...
        return sb.toString().compareTo(word) == 0;
    }
    ...
    private String step2(String str) {
        ...
        for (String[] suffixe : suffixes) {
            if (hasSuffix(str, suffixe[0], stem)) {
                if (measure(stem.str) > 0) {
                    str = stem.str + suffixe[1];
                    return str;
                }
            }
        }
    ...
    private String stripPrefixes(String str) {
        ...
        for (String prefixe : prefixes) {
            if (str.startsWith(prefixe)) {
                String temp = "";
                for (int j = 0; j < str.length() - prefixe.length(); j++)
                    temp += str.charAt(j + prefixe.length());
                return temp;
            }
        }
